<!--select2-->
<link href="<?php echo site_url();?>js/select2.min.css">
<!-- Latest compiled and minified CSS Bootstrap Core CSS-->
<link rel="stylesheet" href="<?php echo site_url();?>css/bootstrap.min.css">
<!-- Optional theme -->
<link rel="stylesheet" href="<?php echo site_url();?>css/bootstrap-theme.min.css">
<!-- Bootstrap Core CSS <link href="<?php //echo site_url();?>vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">-->
...
<!--boostrap-->
<script src="<?php echo site_url();?>js/jquery-3.3.1.js"></script>
...
<!-- mascara-blade-->
<script src="<?php echo site_url();?>js/jquery.inputmask.bundle.js"></script>
