             ...
             <div class="panel panel-primary"> 
              ...
              <div class="panel-body"> 
                ...
                <?php foreach ($editarprov as $item) {
                  ...
                  $representante=$item['representante_empresa'];
                } ?>
                  <!-- Primer campo-->
                   <div class="col-md-12 form-group input-group">
                      <label for="" class="input-group-addon"> Nombre de la empresa:</label>
                      <input type="text" id="nombre" name="nombre_empresa" class="form-control" value="<?php echo $nombre; ?>" >
                   </div>
                    <!-- Segundo campo-->
                    <div class="col-md-12 form-group input-group">
                    ...
                    <!-- Tercero campo-->
                    <div class="col-md-12 form-group input-group">s
                      <label for="" class="input-group-addon"> Representante:</label>
                      <input type="text" id="repre" name="representante_empresa" class="form-control" value="<?php echo $representante; ?>">
                    </div>
                     <!-- Cuarto campo-->
                    <div class="col-md-12 form-group input-group">
