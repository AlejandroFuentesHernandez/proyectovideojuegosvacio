...
<div id="page-wrapper">
<div class="modal fade" data-backdrop="static" id="empleadosmodal"  role="dialog" aria-labelly="exampleModalLongTitle" aria-hidden="true">
                  ...
                  <!-- Primer campo-->
                   ...
                   <div class="col-md-12 form-group input-group">
                    ...
                    <div class="col-md-12 form-group input-group">
                      ...
                      <input type="text" id="DUI_empleado" name="DUI_empleado" title="00000000-0" placeholder="55555555-5" class="form-control" value="<?php echo $idd['DUI_empleado'];?>">
                    </div>
                    <!-- Cuarto campo-->
                    <div class="col-md-12 form-group input-group">
                    ...
                    <select id="id_tienda" name="id_tienda" class="form-control" value="<?php echo $idd['id_tienda'];?>">
                    </select>
                  </div> 
